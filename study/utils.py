...
def study_custom_labels(study_form):
    ...
    study_form['max_participants'].label = "Maximum Participants"
    study_form['min_age'].label = "Minimum Age"
    study_form['max_age'].label = "Maximum Age"
    study_form['min_yoe'].label = "Minimum Experience"
    study_form['max_yoe'].label = "Maximum Experience"
